...
function DisclosureMenu (domNode) {
  ...
  this.hamburgerButtonNode.appendChild(this.createSVGNodeMenuOpen());
  this.hamburgerButtonNode.appendChild(this.createSVGNodeMenuClose());
  ...
  for (i = 0; i < containerNodes.length; i++) {
    ...
    if (containerNode.classList.contains('menu-item-has-children')) {
      containerNode.querySelector('a').appendChild(this.createSVGNodeMenuToggle());
    } else {
      containerNode.querySelector('a').appendChild(this.createSVGNodeMenuLink());
    }
...
*/
DisclosureMenu.prototype.createSVGNodeMenuToggle = function () {
...
*/
DisclosureMenu.prototype.createSVGNodeMenuLink = function () {
  const xmlns = 'http://www.w3.org/2000/svg';
...
DisclosureMenu.prototype.createSVGNodeMenuOpen = function () {
  const xmlns = 'http://www.w3.org/2000/svg';
...
DisclosureMenu.prototype.createSVGNodeMenuClose = function () {
  const xmlns = 'http://www.w3.org/2000/svg';
